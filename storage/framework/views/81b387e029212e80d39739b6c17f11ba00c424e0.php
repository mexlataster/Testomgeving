  ...
  <div class="container">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo e(action('MailController@edit', $post['id'])); ?>" class="btn btn-info btn-lg">Lezen</a></td>
        <td>
          <form action="<?php echo e(action('MailController@destroy', $post['id'])); ?>" method="post">
