...
<div class="container">
  ...
  <div class="container">
    ...
    <thead>
      <tr>
        <th><a href="crud/create" class="btn btn-info btn-lg">Mail Maken</a></th>
        <th>Afzender</th>
        <th>Onderwerp</th>
        <th>Bericht</th>
      </tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo e(action('CRUDController@edit', $post['id'])); ?>" class="btn btn-info btn-lg">Lezen</a></td>
        <td>
