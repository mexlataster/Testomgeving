...
<html>
  ...
  <body>
    <div class="container">
        ...
        <br>
    <div class="container">
      <form method="post" action="<?php echo e(url('adminmail')); ?>">
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <label for="ex1">
            <input type="text" class="form-control form-control-lg" id="lgFormGroupInput" placeholder="user" name="user" value="admin@pencaksilat.nl">
            </label>
          </div>
